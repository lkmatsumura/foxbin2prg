...
Define Class CL_DBC_FIELDS_DB As CL_DBC_COL_BASE Of 'cl_dbc_col_base.prg'
   #If .F.
      Local This As CL_DBC_FIELDS_DB Of 'cl_dbc_fields_db.prg'
   #Endif
               ...
               *.n_Campos = 0  && Descomentar para forzar modo LEGACY
               For I = m.I + 1 To tnCodeLines
                  ...
                  Case C_FIELD_I $ tcLine
                     loField = NewObject('CL_DBC_FIELD_DB', 'cl_dbc_field_db.prg')
