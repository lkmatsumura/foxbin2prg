...
PROCEDURE Lang_Apply_DE
   ...
   WITH toLang
      ...
      .C_CFG_REF_INTRO_LOC                                            = "Programmatische Konfiguration für FoxBin2Prg (keine .cfg-Dateien auf der Festplatte)."
      TEXT TO .C_CFG_REF_USAGE_LOC TEXTMERGE NOSHOW FLAGS 1 PRETEXT 1+2
         <<>>loCfg = loF2b.newConfig()  && Werkseinstellungen klonen
         <<>>loCfg.l_NoTimestamps = .T. && Eigenschaften überschreiben
      ...
      .C_CFG_REF_SEC_DBF_LOC                                          = "DBF / DBC / Konvertierungsunterstützung"
      ...
      .C_INCORRECT_VFP9_VERSION__MISSING_SP1_LOC                      = "Falsche VFP 9 Version - SP1 fehlt! Erwartet: 3504 oder höher, aktuell: " + Version(4)
